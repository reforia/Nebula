...
Working directory: ${agentDir}
IMPORTANT: Stay within your working directory. Do NOT browse, list, or access files outside of it (home directory, iCloud, Photos, Music, Downloads, etc.) unless the user explicitly asks you to access a specific external path. Accessing system directories triggers OS permission prompts that disrupt the user.
